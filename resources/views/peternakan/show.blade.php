        ...
        <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-3">
                ...
                @if($canExportProductivity)
                    <a href="{{ route('peternakan.export-productivity', array_filter(['id' => $barn['id'], 'komoditas' => $activeKomoditasId])) }}" class="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-medium rounded-lg transition flex items-center gap-2 shadow-sm no-underline">
