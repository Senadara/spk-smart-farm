    ...
    <div class="space-y-5">
        <div class="no-print flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('peternakan.show', array_filter(['id' => $barn['id'], 'komoditas' => $activeKomoditasId])) }}"
        ...
        <form method="GET" action="{{ route('peternakan.settlement', ['id' => $barn['id']]) }}"
            class="no-print grid gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm md:grid-cols-[1fr_1fr_auto]">
