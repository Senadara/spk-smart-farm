                                ...
                                <div class="flex min-h-[180px] flex-col justify-between rounded-xl border border-amber-100 bg-white p-4 shadow-sm transition hover:border-amber-200 hover:shadow-md">
                                    <div class="space-y-3">
                                        ...
                                        <div class="space-y-1.5">
                                            @foreach(array_slice($plan['signals'], 0, 2) as $signal)
                                                <div class="rounded-lg bg-slate-50 px-3 py-2">
                                                    <p class="text-[11px] font-bold text-slate-700">{{ $signal['title'] }}</p>
                                                    <p class="mt-0.5 line-clamp-1 text-[10px] text-slate-500">{{ $signal['message'] }}</p>
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
