    ...
    <div class="p-5">
        @if($total === 0)
            ...
            <div class="text-center py-4">
                <svg class="w-10 h-10 mx-auto text-emerald-400 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
        ...
        @else
            ...
            <div class="space-y-3">
                @foreach(array_slice($recentAlerts, 0, 5) as $alert)
                    ...
                    @endphp
                    <div class="flex items-start gap-2.5 group cursor-pointer hover:bg-[var(--color-gray-50)] rounded-lg p-2 -mx-2 transition-colors">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-2 mt-0.5">
                                <span class="text-xs font-medium text-[var(--color-gray-500)]">{{ $alert['block'] }}</span>
