...
test.describe('Modul SPK Fuzzy Mamdani - E2E Tests', () => {
    ...
    test('Positif - POST /process menyimpan log ke database (SpkFuzzyLog)', async ({ page }) => {
         ...
         * Then: Log dapat diakses via GET /spk-fuzzy/history/{id}
         */
    ...
    test('Negatif - POST /process dengan coop_id invalid (tidak ditemukan) tidak crash', async ({ page }) => {
        /**
         * Given: coop_id yang tidak exist
         * When: POST /spk-fuzzy/process?coop_id={invalid-uuid}
    ...
    test('Positif - GET /history returns array of logs dengan default limit', async ({ page }) => {
         ...
         * When: GET /spk-fuzzy/history
         * Then: Return 200 dengan data array (default limit=10)
         */
    ...
    test('Positif - GET /history?limit=5 returns max 5 logs', async ({ page }) => {
         ...
         * When: GET /spk-fuzzy/history?limit=5
    ...
    test('Positif - GET /history?coop_id={uuid} filters by specific kandang', async ({ page }) => {
         ...
         * When: GET /spk-fuzzy/history?coop_id={uuid}
        ...
        // Note: We can't easily verify all barn names match without DB access
    });
    ...
    test('Positif - History data memiliki format lengkap (date, mode, barn, status, verdict, scores)', async ({ page }) => {
         ...
         * When: GET /spk-fuzzy/history?limit=1
    ...
    test('Edge Case - GET /history dengan limit>50 tetap return max 50 (protection)', async ({ page }) => {
         ...
         * When: GET /spk-fuzzy/history?limit=100
    ...
    test('Negatif - GET /history/{invalid-id} returns 404 Not Found', async ({ page }) => {
         ...
         * When: GET /spk-fuzzy/history/{invalid-uuid}
         * Then: Return 404 dengan error message
         */
    ...
    test('Negatif - GET /history/{malformed-id} returns 404 Not Found', async ({ page }) => {
        /**
         * Given: ID format invalid (bukan UUID)
         * When: GET /spk-fuzzy/history/invalid-id-xxx
    ...
    test('Integration - Complete flow: Process → History list includes log → Detail matches process result', async ({ page }) => {
        /**
    ...
    test('Advanced - Process result status labels are valid (Buruk|Waspada|Baik|Optimal)', async ({ page }) => {
         ...
         * When: Process fuzzy
         * Then: Status labels harus dari set yang valid
         */
    ...
    test('Advanced - Process result kausalitas labels are valid (from config)', async ({ page }) => {
        /**
         * Given: Kausalitas engine configured
         * When: Process fuzzy
         * Then: diagnosis_kausalitas adalah label yang valid
         */
    ...
    test('Performance - POST /process completes dalam waktu reasonable (<5 detik)', async ({ page }) => {
        /**
    ...
    test('Performance - GET /config completes dalam waktu reasonable (<2 detik)', async ({ page }) => {
        /**
        ...
        // Assert: Performance < 2000ms
        expect(fetchTime).toBeLessThan(2000);
    });

    test('Performance - GET /history dengan limit=10 completes dalam waktu reasonable (<1 detik)', async ({ page }) => {
        /**
