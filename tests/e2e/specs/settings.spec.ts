...
test.describe('Modul Halaman Pengaturan (Setting) - E2E QA', () => {
    ...
    test('Positif - Fuzzy card (jika visible) has amber icon dengan chart bars SVG', async ({ page }) => {
        /**
    ...
    test('Performance - Settings page loads dalam < 3 seconds', async ({ page }) => {
        /**
    ...
    test('Performance - Card navigation responds instantly (< 500ms)', async ({ page }) => {
        /**
         * Given settings page loaded
         * When click any card
