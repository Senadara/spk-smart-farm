...
test.describe('Modul IoT Config - CRUD Operations E2E', () => {
     ...
     test('Positif - CREATE Protocol baru dengan data valid', async ({ page }) => {
          /**
           * Given: Admin berada di halaman Config IoT tab Protokol
           * When: Admin mengisi form Tambah Protokol dengan data valid dan submit
     ...
     test('Negatif - CREATE Protocol dengan nama duplikat', async ({ page }) => {
           ...
           * Then: Sistem menampilkan error validasi duplikat
           */
     ...
     test('Positif - DELETE Protocol yang tidak digunakan', async ({ page }) => {
          /**
     ...
     test('Negatif - DELETE Protocol yang masih digunakan', async ({ page }) => {
          /**
           * Given: Ada protocol yang sudah digunakan oleh koneksi
           * When: Admin mencoba menghapus protocol tersebut
           * Then: Sistem menampilkan error karena masih ada relasi
           */
     ...
     test('Positif - CREATE Connection dengan MQTT Broker', async ({ page }) => {
          /**
           * Given: Sudah ada protocol terdaftar
     ...
     test('Negatif - CREATE Connection tanpa endpoint (kosong semua)', async ({ page }) => {
           ...
           * Then: Sistem menampilkan error validasi
           */
     ...
     test('Positif - CREATE Parameter Sensor baru', async ({ page }) => {
          /**
     ...
     test('Negatif - CREATE Parameter dengan kode duplikat', async ({ page }) => {
          /**
           * Given: Sudah ada parameter dengan kode tertentu
           * When: Coba buat parameter baru dengan kode sama
           * Then: Validasi error duplikat muncul
           */
     ...
     test('Positif - DELETE Parameter yang tidak digunakan', async ({ page }) => {
          /**
     ...
     test('Positif - CREATE Commodity Parameter dengan min max value', async ({ page }) => {
          /**
     ...
     test('Negatif - CREATE Commodity Parameter dengan min >= max', async ({ page }) => {
          /**
           * Given: Admin di form tambah commodity parameter
           * When: Input min value lebih besar atau sama dengan max
           * Then: Validasi error muncul
           */

          // Arrange
          await iotPage.gotoConfig();
          const paramCode = `INVALID_RANGE_${Date.now()}`;
          await iotPage.createParameter(paramCode, 'Invalid Range Test', 'unit');
     ...
     test('Negatif - CREATE Commodity Parameter duplikat kombinasi', async ({ page }) => {
          /**
     ...
     test('Positif - DELETE Commodity Parameter', async ({ page }) => {
          /**
