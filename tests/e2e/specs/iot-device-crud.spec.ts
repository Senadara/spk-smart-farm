...
test.describe('Modul IoT Device Management - CRUD Operations E2E', () => {
     ...
     test('Positif - CREATE Device dengan semua field valid', async ({ page }) => {
          /**
     ...
     test('Negatif - CREATE Device tanpa deviceCode (mandatory field)', async ({ page }) => {
          /**
     ...
     test('Positif - DELETE Device yang tidak memiliki sensor data', async ({ page }) => {
          /**
     ...
     test('Positif - CREATE Parameter Mapping untuk device', async ({ page }) => {
          /**
     ...
     test('Negatif - CREATE Mapping duplikat device-parameter', async ({ page }) => {
          /**
     ...
     test('Positif - DELETE Mapping', async ({ page }) => {
          /**
