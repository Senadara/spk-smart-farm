...
$pdo->exec("INSERT INTO unitBudidaya (id, jenisBudidayaId, nama, lokasi, tipe, luas, kapasitas, jumlah, status, isDeleted, createdAt, updatedAt) 
VALUES ('$coopId1', '$jbId', 'Kandang Petelur Dummy 1', 'Blok A', 'hewan', 100, 500, 480, 1, 0, NOW(), NOW())");
